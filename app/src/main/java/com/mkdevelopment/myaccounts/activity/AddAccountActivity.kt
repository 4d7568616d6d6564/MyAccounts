...
class AddAccountActivity : AppCompatActivity() {
        ...
        if (binding.titleEditText.text?.isEmpty() == true) {
            ...
            accountDataViewModel.insertData(
                AccountEntity(
                    ...
                    updatedTime = "",
                    icon = drawableList[selectedIconPosition],
                )
            )
            runOnUiThread {
                Toast.makeText(
    ...
    private fun initialize() {
        ...
        drawableList.add(R.drawable.ic_ui_user)
        drawableList.add(R.drawable.ic_ui_sms)
        drawableList.add(R.drawable.ic_ui_location)
        drawableList.add(R.drawable.password_toggle_drawable)
        drawableList.add(R.drawable.ic_adobe)
        drawableList.add(R.drawable.ic_apple)
        drawableList.add(R.drawable.ic_apple_music)
        drawableList.add(R.drawable.ic_battle_net)
        drawableList.add(R.drawable.ic_behance)
        drawableList.add(R.drawable.ic_behance_only)
        drawableList.add(R.drawable.ic_creative_cloud)
        drawableList.add(R.drawable.ic_devianart)
        drawableList.add(R.drawable.ic_discord)
        drawableList.add(R.drawable.ic_discord_full)
        drawableList.add(R.drawable.ic_dribbble)
        drawableList.add(R.drawable.ic_dribbble_colored)
        drawableList.add(R.drawable.ic_dribbble_white)
        drawableList.add(R.drawable.ic_drive)
        drawableList.add(R.drawable.ic_dropbox)
        drawableList.add(R.drawable.ic_electronic_arts)
        drawableList.add(R.drawable.ic_facebook_2023)
        drawableList.add(R.drawable.ic_facebook_brand_2023)
        drawableList.add(R.drawable.ic_facebook_messenger_2013)
        drawableList.add(R.drawable.ic_facebook_messenger_2020)
        drawableList.add(R.drawable.ic_figma)
        drawableList.add(R.drawable.ic_fiverr)
        drawableList.add(R.drawable.ic_github)
        drawableList.add(R.drawable.ic_github_v2)
        drawableList.add(R.drawable.ic_gmail)
        drawableList.add(R.drawable.ic_google_play)
        drawableList.add(R.drawable.ic_hbo)
        drawableList.add(R.drawable.ic_imdb)
        drawableList.add(R.drawable.ic_instagram_icon)
        drawableList.add(R.drawable.ic_instagram_2022)
        drawableList.add(R.drawable.ic_instagram_black_2022)
        drawableList.add(R.drawable.ic_instagram_white_line)
        drawableList.add(R.drawable.ic_line)
        drawableList.add(R.drawable.ic_linkedin)
        drawableList.add(R.drawable.ic_linkedin_circle)
        drawableList.add(R.drawable.ic_mailchimp)
        drawableList.add(R.drawable.ic_mastercard)
        drawableList.add(R.drawable.ic_medium)
        drawableList.add(R.drawable.ic_medium_circle)
        drawableList.add(R.drawable.ic_messenger_original)
        drawableList.add(R.drawable.ic_messenger_white)
        drawableList.add(R.drawable.ic_microsoft)
        drawableList.add(R.drawable.ic_netflix)
        drawableList.add(R.drawable.ic_notion)
        drawableList.add(R.drawable.ic_paypal)
        drawableList.add(R.drawable.ic_pinterest)
        drawableList.add(R.drawable.ic_quora)
        drawableList.add(R.drawable.ic_reddit)
        drawableList.add(R.drawable.ic_reddit_circle)
        drawableList.add(R.drawable.ic_reddit_v2)
        drawableList.add(R.drawable.ic_shutterstock)
        drawableList.add(R.drawable.ic_signal)
        drawableList.add(R.drawable.ic_skype)
        drawableList.add(R.drawable.ic_snapchat)
        drawableList.add(R.drawable.ic_snapchat_yellow_circle)
        drawableList.add(R.drawable.ic_sound_cloud_circle)
        drawableList.add(R.drawable.ic_soundcloud)
        drawableList.add(R.drawable.ic_spotify)
        drawableList.add(R.drawable.ic_telegram)
        drawableList.add(R.drawable.ic_telegram_only)
        drawableList.add(R.drawable.ic_threads_black_line)
        drawableList.add(R.drawable.ic_threads_full)
        drawableList.add(R.drawable.ic_threads_line_gradient)
        drawableList.add(R.drawable.ic_tiktok)
        drawableList.add(R.drawable.ic_tumblr)
        drawableList.add(R.drawable.ic_tumblr_circle)
        drawableList.add(R.drawable.ic_twitch)
        drawableList.add(R.drawable.ic_twitter)
        drawableList.add(R.drawable.ic_viber)
        drawableList.add(R.drawable.ic_vimeo)
        drawableList.add(R.drawable.ic_visa)
        drawableList.add(R.drawable.ic_vk)
        drawableList.add(R.drawable.ic_vk_only)
        drawableList.add(R.drawable.ic_wechat)
        drawableList.add(R.drawable.ic_whatsapp)
        drawableList.add(R.drawable.ic_whatsapp_white_line)
        drawableList.add(R.drawable.ic_x_twitter)
        drawableList.add(R.drawable.ic_youtube)
        drawableList.add(R.drawable.ic_youtube_circle)
        drawableList.add(R.drawable.ic_youtube_music)
        drawableList.add(R.drawable.ic_zoom)

        binding.iconRecyclerView.apply {
            layoutManager =
                LinearLayoutManager(this@AddAccountActivity, LinearLayoutManager.HORIZONTAL, false)
            adapter = IconAdapter { selected ->
